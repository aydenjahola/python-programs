...
App.iconbitmap("D:\python_projects\conversion_app\conversion aoo v0.5\img\logo.ico")
...
def open():
    ...
    dic.iconbitmap("D:\python_projects\conversion_app\conversion aoo v0.5\img\logo.ico")
    ...
    button_quit2 = Button(dic, text="Exit Program", command=dic.destroy)
    button_quit2.pack()
